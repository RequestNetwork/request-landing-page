...
const CONTACT_URL =
  "https://2deywy.share-eu1.hsforms.com/2b92phs9LR_eJdeZoxzmoMA?utm_source=(direct)&utm_medium=(none)&landing_page=https%3A%2F%2Frequest.network%2F";
          ...
          <div className="rn-hero-grid">
            <div className="rn-hero-content section-animate">
              ...
              <div className="rn-hero-ctas">
                ...
                <a href={DOCS_URL} className="rn-btn rn-btn-secondary">
                  Explore API docs
                </a>
              </div>
            </div>
              ...
              <div className="rn-hero-mockup-card">
                <div className="rn-mockup-header">
                  <div className="rn-mockup-header-left">
                    ...
                    <div>
                      <div className="rn-mockup-title">Payment Request #1041</div>
                    </div>
                  </div>
                  <span className="rn-mockup-badge rn-mockup-badge-paid">Paid</span>
                </div>
                <div className="rn-mockup-row">
                  <span className="rn-mockup-row-label">Network</span>
                  <span className="rn-mockup-row-value">Ethereum</span>
                </div>
                <div className="rn-mockup-row">
                  <span className="rn-mockup-row-label">Currency</span>
                  <span className="rn-mockup-row-value">USDC</span>
                </div>
                <div className="rn-mockup-row">
                  <span className="rn-mockup-row-label">Due Date</span>
                  <span className="rn-mockup-row-value">Feb 15, 2026</span>
                </div>
                <div className="rn-mockup-row">
                  <span className="rn-mockup-row-label">Status</span>
                  <span className="rn-mockup-row-value">
                    <svg width="12" height="12" fill="none" viewBox="0 0 16 16">
                      <circle cx="8" cy="8" r="6" fill="#00D084" />
                      <path
                        d="M5.5 8l2 2 3-3.5"
                        stroke="white"
                        strokeWidth="1.5"
      ...
      <div className="rn-stats-border-wrapper">
        <section className="rn-stats-section">
          <div className="rn-stats-grid">
            <div className="rn-stat-item">
              <dd className="rn-stat-value">26+</dd>
              <dt className="rn-stat-label">Chains Supported</dt>
            </div>
            <div className="rn-stat-item">
              <dd className="rn-stat-value">$1B+</dd>
              <dt className="rn-stat-label">Volume Processed</dt>
            </div>
            <div className="rn-stat-item">
              <dd className="rn-stat-value">2017</dd>
              <dt className="rn-stat-label">Founded In</dt>
            </div>
          </div>
        </section>
      </div>
        ...
        <div className="rn-container">
          ...
          <div className="rn-products-grid">
            ...
            <div className="rn-product-card rn-product-card-invoicing section-animate">
              ...
              <p className="rn-product-card-desc">
                Let customers pay you in any crypto, on any chain. Payments are detected automatically and funds go
                straight to your wallet.
              </p>
              <div className="rn-product-card-mockup">
                <div className="rn-mini-mockup-row">
                  <div className="rn-mini-mockup-left">
                    <div className="rn-mini-mockup-dot" style={{ background: "#5DC086" }} />
                    <span className="rn-mini-mockup-text">REQ-1041</span>
                  </div>
                ...
                <div className="rn-mini-mockup-row">
                  <div className="rn-mini-mockup-left">
                    <div className="rn-mini-mockup-dot" style={{ background: "#FFB020" }} />
                    <span className="rn-mini-mockup-text">REQ-1042</span>
                  </div>
                ...
                <div className="rn-mini-mockup-row">
                  <div className="rn-mini-mockup-left">
                    <div className="rn-mini-mockup-dot" style={{ background: "#FF4D4F" }} />
                    <span className="rn-mini-mockup-text">REQ-1043</span>
                  </div>
              ...
              <ul className="rn-product-card-features">
                <li>
                  <CheckIcon /> Recipients get paid in preferred currency and chain.
                </li>
                <li>
                  <CheckIcon /> Payments across 26+ networks.
                </li>
                <li>
                  <CheckIcon /> No intermediaries. No custody.
                </li>
                <li>
                  <CheckIcon /> Accept crypto payments your way.
                </li>
              </ul>
              <a
                href={CONTACT_URL}
            ...
            <div className="rn-product-card rn-product-card-finance section-animate">
              <div className="rn-product-card-icon">
                <svg width="26" height="26" fill="none" viewBox="0 0 24 24">
                  <rect x="2" y="4" width="20" height="16" rx="4" stroke="currentColor" strokeWidth="1.8" />
                  <path d="M6 12h3M6 16h2" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
                  <rect
                    x="14"
                    y="10"
                    width="5"
              ...
              <p className="rn-product-card-desc">
                Send payouts and move funds out of crypto with confidence. Pay vendors, suppliers, or freelancers, and
                route funds to the wallets you choose.
              </p>
              <div className="rn-product-card-mockup">
                <div className="rn-mini-dashboard">
                  ...
                  <div className="rn-mini-dash-card">
                    ...
                    <div className="rn-mini-dash-change" style={{ color: "var(--color-text-muted)" }}>
                      3 approvals needed
                    </div>
                  </div>
                  <div className="rn-mini-dash-chart" aria-hidden="true">
                    {[30, 50, 35, 65, 45, 80, 60, 70, 55, 90, 75, 85].map((h, i) => (
                      <div
                        key={i}
                        className="rn-mini-bar"
                        style={{
                          height: `${h}%`,
                          background: i === 9 ? "var(--color-accent-secondary)" : `rgba(0,180,255,${0.2 + h / 300})`,
                        }}
                      />
                    ))}
                  </div>
              ...
              <ul className="rn-product-card-features">
                <li>
                  <CheckIcon color="#00B4FF" bg="rgba(0,180,255,0.12)" /> Send crypto to thousands in one click.
                </li>
                <li>
                  <CheckIcon color="#00B4FF" bg="rgba(0,180,255,0.12)" /> Convert crypto to fiat.
                </li>
                <li>
                  <CheckIcon color="#00B4FF" bg="rgba(0,180,255,0.12)" /> Shared wallets with defined roles.
                </li>
                <li>
                  <CheckIcon color="#00B4FF" bg="rgba(0,180,255,0.12)" /> Total oversight of your crypto funds.
                </li>
              </ul>
              <a
                href={CONTACT_URL}
      ...
      <section className="rn-integrations-section section-animate">
        <div className="rn-container">
          <div className="rn-section-heading">
            <h2 style={{ fontSize: "48px" }}>Deployed on 26+ blockchains</h2>
          </div>
          <div className="rn-chains-grid">
            {chains.map((c) => (
              <span key={c.name} className="rn-chain-chip">
                <span className="rn-chain-icon" style={{ background: c.color }}>
                  {c.letter}
                </span>{" "}
                {c.name}
              </span>
            ...
            <span
              className="rn-chain-chip"
              style={{
                background: "rgba(93,192,134,0.06)",
                borderColor: "rgba(93,192,134,0.15)",
          ...
          <div className="rn-features-grid">
            <div className="rn-feature-card section-animate">
              <div className="rn-feature-icon rn-feature-icon-green">
                <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
                  <path
                    d="M4 10c0-3.3 2.7-6 6-6s6 2.7 6 6-2.7 6-6 6"
                    stroke="currentColor"
                    strokeWidth="1.6"
                    strokeLinecap="round"
                  />
              ...
              <h3>
                One integration. <br /> Every major chain.
              </h3>
            ...
            <div className="rn-feature-card section-animate">
              <div className="rn-feature-icon rn-feature-icon-blue">
                <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
                  ...
                  <circle cx="7" cy="12.5" r="1.5" fill="currentColor" opacity="0.3" />
                </svg>
              </div>
            ...
            <div className="rn-feature-card section-animate">
              <div className="rn-feature-icon rn-feature-icon-purple">
                <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
                  <path
                    d="M10 2v4M10 14v4M18 10h-4M6 10H2"
                    stroke="currentColor"
                    strokeWidth="1.6"
                    strokeLinecap="round"
                  />
          ...
          <div className="rn-cta-box">
            <div className="rn-cta-content">
              ...
              <div className="rn-cta-buttons">
                ...
                <a href={DOCS_URL} className="rn-btn-outline-light">
                  Explore API Docs
                </a>
              </div>
            </div>
